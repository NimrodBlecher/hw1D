...
highTech.removeEmployee(3);
    ...
    cout << endl << endl << endl << endl;
    print2D(highTech.getCompany(2) -> getEmployeesTreeById());
highTech.removeEmployee(2);
highTech.removeEmployee(4);
highTech.removeEmployee(1);
highTech.removeEmployee(5);
cout << "Companies By Id is : " << endl;
cout << endl << endl << endl << endl;
print2D(companies);
cout << "Employees By Id is : " << endl;
